 ...
 * from DOM elements.
 * Stubbed because the shared design-mode module is not available
...
function initDesignMode(getStyleInfo: GetStyleInfo): () => void {
  // no-op when the shared design-mode module is unavailable
  return () => {};
}
