  ...
  useEffect(() => {
    if ('serviceWorker' in navigator) {
      navigator.serviceWorker.register('/sw.js').catch(() => {
        // PWA service worker registration is optional
      });
    }
  }, []);
  ...
  return (
    <html lang="id">
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="KarirHub" />
        <meta name="description" content="Platform rekrutmen digital yang menghubungkan pencari kerja berbakat dengan perusahaan terkemuka di Indonesia" />
