      ...
      <div className="flex-1 p-6 w-full">
        <div className="flex items-center justify-between mb-6">
          ...
          {unreadCount > 0 && (
            <button
              onClick={markAllRead}
              className="flex items-center gap-2 px-4 py-2 text-sm text-blue-600 border border-blue-200 rounded-xl hover:bg-blue-50 font-medium"
            >
            ...
            myNotifs.map((n) => {
              ...
              return (
                <div
                  ...
                  className={`rounded-2xl border p-4 cursor-pointer transition-all ${!isRead ? "bg-blue-50 border-blue-200 hover:bg-blue-100" : "bg-white border-gray-200 hover:bg-gray-50"}`}
                >
